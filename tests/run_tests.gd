...
const SUITES := [
	...
	preload("res://tests/test_combat_extras.gd"),
	preload("res://tests/test_luck.gd"),
	...
	preload("res://tests/test_rules_documents.gd"),
	preload("res://tests/test_netrun_initiative.gd"),
	...
	preload("res://tests/test_app_settings.gd"),
	...
	preload("res://tests/test_board_surfaces.gd"),
]
